...
public class FileSystemServer {
    ...
    /**
     * Any exception that occurred during startup.
     * <p/>
     * Guarded by {@link #lock}.
     */
    ...
    /**
     * Gets the port that the file system server is/will serve on.
     *
    ...
    /**
     * Gets the root url that the file system server is/will serve on.
     *
